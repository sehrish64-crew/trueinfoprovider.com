...
export default function CheckoutPage() {
  ...
  if (!paymentData) {
    return (
      <div className="min-h-screen pt-20 sm:pt-24 bg-emerald-50 flex items-center justify-center px-4">
        <div className="w-full max-w-xl rounded-2xl sm:rounded-[2rem] border border-gray-200 bg-white p-6 sm:p-10 shadow-xl shadow-emerald-100 text-center">
          <AlertCircle className="w-12 h-12 sm:w-16 sm:h-16 text-yellow-500 mx-auto mb-4" />
          <h1 className="text-xl sm:text-2xl font-bold text-gray-900 mb-2">Payment Data Not Found</h1>
          <p className="text-sm sm:text-base text-gray-600 mb-6">Please complete the pricing form first.</p>
          <button
            onClick={() => router.push('/pricing')}
            className="px-6 py-2.5 sm:py-3 bg-emerald-600 hover:bg-emerald-500 text-white font-semibold rounded-2xl transition-colors text-sm sm:text-base"
          >
            Go to Pricing
          </button>
        </div>
    ...
    return (
      <div className="min-h-screen pt-20 sm:pt-24 bg-emerald-50 flex items-center justify-center px-4">
        <motion.div
          ...
          className="w-full max-w-lg rounded-2xl sm:rounded-[2rem] border border-gray-200 bg-white p-6 sm:p-10 shadow-xl shadow-emerald-100 text-center"
        >
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
        ...
        >
          ...
          <p className="text-sm sm:text-base lg:text-xl text-gray-600">
            Secure checkout for your AI Health Report
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 sm:gap-8">
          ...
          >
            ...
            {selectedPlan && (
              <div className="space-y-3 sm:space-y-4">
                <div className="flex items-center justify-between p-3 sm:p-4 rounded-2xl sm:rounded-3xl border border-gray-200 bg-emerald-50">
                  <div>
                  ...
                  <span className="text-xl sm:text-2xl font-bold text-emerald-600 ml-3 flex-shrink-0">
                    £{selectedPlan.price}
                  </span>
                </div>
            ...
            <div className="mt-4 sm:mt-6 p-3 sm:p-4 rounded-2xl sm:rounded-3xl border border-emerald-200 bg-emerald-50">
              <div className="flex items-center gap-2 sm:gap-3">
                <Shield className="w-4 h-4 sm:w-5 sm:h-5 text-emerald-600 flex-shrink-0" />
                <span className="text-xs sm:text-sm text-emerald-700 font-medium">Secure Payment</span>
              </div>
          ...
          >
            ...
            <div className="space-y-4 sm:space-y-6">
              ...
              {/* Customer Info */}
              <div className="p-3 sm:p-4 rounded-2xl sm:rounded-3xl border border-gray-200 bg-emerald-50">
              ...
              <div className="space-y-3 sm:space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 sm:px-4 py-2.5 sm:py-3 bg-gray-50 border border-gray-200 rounded-xl sm:rounded-2xl text-sm text-gray-900 placeholder-gray-400 focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-all"
                  />
                </div>
              ...
              <button
                ...
                className="w-full px-6 sm:px-8 py-3 sm:py-4 bg-emerald-600 hover:bg-emerald-500 disabled:bg-gray-400 text-white font-semibold rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 flex items-center justify-center gap-2 sm:gap-3 disabled:cursor-not-allowed text-sm sm:text-base"
              >
                {isProcessing ? (
                  <>
