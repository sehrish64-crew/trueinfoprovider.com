...
export async function buildAnalysisPdf(
  ...
  doc.fontSize(20).fillColor("#0f172a").text("True Info Provider", { align: "left" });
  doc.moveDown(0.5);
  doc.fontSize(14).fillColor("#475569").text("AI Vehicle Diagnostics & Vehicle Health Summary", { align: "left" });
  doc.moveDown(1);
